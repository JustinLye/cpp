...
COMP = $(CCX) $(CXXFlags)
JLOBJ = $(BINDIR)/jl.o $(BINDIR)/jlutility.o $(BINDIR)/jlarray.o $(BINDIR)/jlmatrix.o $(BINDIR)/jlshape.o $(BINDIR)/jlmath.o
JLDEP = $(SRCDIR)/jl.cpp $(BINDIR)/jlutility.o $(BINDIR)/jlarray.o $(BINDIR)/jlmatrix.o $(BINDIR)/jlshape.o $(BINDIR)/jlmath.o
